...
<table border="1" width="50%" style="border-collapse: collapse;">
    <form method="POST" action="pages/Category/CategoryLogic.php?idsanpham=<?php echo $_GET['idsanpham'] ?>" enctype="multipart/form-data">
        <?php
        ...
        ?>
            ...
            <tr>
                <td>Số lượng</td>
                <td><input type="text" name="id_danhmuc" value="<?php echo $row['id_danhmuc'] ?>"></td>
            </tr>
            <tr>
                <td>Hình ảnh</td>
                <td><input type="file" name="hinhanh">
                    <img src="pages/Category/ProductImages/<?php echo $row['hinhanh'] ?> " width="150px">
                </td>
            </tr>
            <tr>
                <td>Tóm tắt</td>
