        ...
        <div class="appCard">
            ...
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col">
                        <select name="province" class="form-select form-select mb-3" id="city" aria-label=".form-select">
                            <option value="" selected>Chọn tỉnh thành</option>
                        </select>
                    </div>
                    <div class="col">
                        <select name="district" class="form-select form-select mb-3" id="district" aria-label=".form-select">
                            <option value="" selected>Chọn quận huyện</option>
                        </select>
                    </div>

                    <div class="col">
                        <select name="ward" class="form-select form-select" id="ward" aria-label=".form-select">
