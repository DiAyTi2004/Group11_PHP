        ...
        <form action="process_payment.php" method="POST">
            ...
            <div class="mb-3">
                <div class="row">
                    ...
                    <div class="col">
                        <select class="form-select form-select mb-3" id="city" aria-label=".form-select">
                            <option value="" selected>Chọn tỉnh thành</option>
                        </select>
                    </div>
                    <div class="col">
                        <select class="form-select form-select mb-3" id="district" aria-label=".form-select">
                            <option value="" selected>Chọn quận huyện</option>
                        </select>
                    </div>

                    <div class="col">
                        <select class="form-select form-select" id="ward" aria-label=".form-select">
    ...
    <h4 class="text-center mb-4">Thông Tin Thanh Toán</h3>
        <div class="row">
            <div class="mb-3 col">
                ...
                <select class="form-select form-select mb-3" id="shippingMethod" name="shippingMethod" aria-label=".form-select" onchange="updateTotalPayment()">
        ...
        <div class="infor_payment text-end">
            ...
            <button type="sybmit" class="btn btn-success btn-lg mt-5">
