			...
			<table style="width:100%; text-align: center; border-collapse: collapse;" border="1">
				...
				?>
						<tr>
							...
							<td>
								<a href="pages/main/giohang/suasoluong.php?plus=<?php echo $cart_item['id'] ?>"><i class="fa-solid fa-plus"></i></a>
								<?php echo $cart_item['soluong'] ?>
								<a href="pages/main/giohang/suasoluong.php?minus=<?php echo $cart_item['id'] ?>"><i class="fa-solid fa-minus"></i></a>
							</td>
